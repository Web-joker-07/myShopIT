...
const Invoice = () => {
    ...
    const { orderItems, orderStatus, paymentMethod, paymentInfo, totalAmount, itemsPrice, shippingInfo, taxAmount, shippingAmount } = order;
    ...
    const InvoiceHandler = () => {
        ...
        html2canvas(input).then((canvas)=>{
            ...
            pdf.addImage(imgData,"PNG",0,0,imageWidth,0);
        ...
        <>
            <div className="order-invoice my-5">
                <div className="row d-flex justify-content-center mb-5">
                    <button className="btn btn-success col-md-5" onClick={InvoiceHandler}>
                ...
                <div id="order_invoice" className="p-3 border border-secondary">
                    <header className="clearfix">
                        ...
                        <div id="project">
                            ...
                            <div><span>DATE</span> {order?.createdAt.substring(0, 10)}</div>
                        ...
                        <table className="mt-5">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td className="total">${itemsPrice.toFixed(2)}</td>
                                </tr>
